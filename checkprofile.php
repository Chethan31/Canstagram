			...
			<div class="main_header" style="position:fixed;width:88%;height:86px;"><h1>Canstagram</h1></div>
				<div class="drag"></div> 
					...
					<?php
						...
						$p=mysqli_query($db,"SELECT * FROM user WHERE id='$id';");
					...
					<div style='text-align:center;padding-bottom:10px;'><img style='border-radius:50%;border:1px solid Black;' src="<?php echo $row['image']; ?>" height='120' width='130'></div>
					...
					<button style="background-color:Blue;width:80px;height:30px;margin-top:10px;float:right;margin-right:20px;">Back</button>
